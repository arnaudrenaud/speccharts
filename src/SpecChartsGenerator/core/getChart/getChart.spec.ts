...
N1 -- no --> N3`);
  ...
  describe("if spec tree contains nodes with type `table`", () => {
    it("returns a Mermaid flowchart with table node rendered as round-corner rectangle leaf containing formatted table data", () => {
      ...
      expect(result).toEqual(`flowchart TD
N0(["math operations"])
N1("<table style='text-align: left;'><tr><td style='padding: 0 8px 8px 8px'>addition:</td><td style='font-family: monospace; padding: 0 8px 8px 8px'>1</td><td style='padding: 0 8px 8px 8px'>+</td><td style='font-family: monospace; padding: 0 8px 8px 8px'>1</td><td style='padding: 0 8px 8px 8px'>=</td><td style='font-family: monospace; padding: 0 8px 8px 8px'>2</td></tr><tr><td style='padding: 8px'>addition:</td><td style='font-family: monospace; padding: 8px'>1</td><td style='padding: 8px'>+</td><td style='font-family: monospace; padding: 8px'>2</td><td style='padding: 8px'>=</td><td style='font-family: monospace; padding: 8px'>3</td></tr><tr><td style='padding: 8px 8px 0 8px'>addition:</td><td style='font-family: monospace; padding: 8px 8px 0 8px'>2</td><td style='padding: 8px 8px 0 8px'>+</td><td style='font-family: monospace; padding: 8px 8px 0 8px'>1</td><td style='padding: 8px 8px 0 8px'>=</td><td style='font-family: monospace; padding: 8px 8px 0 8px'>3</td></tr></table>")
N0 --> N1
N2("<table style='text-align: left;'><tr><td style='padding: 0 8px 8px 8px'>handles</td><td style='font-family: monospace; padding: 0 8px 8px 8px'>first case</td></tr><tr><td style='padding: 8px'>handles</td><td style='font-family: monospace; padding: 8px'>second case</td></tr><tr><td style='padding: 8px 8px 0 8px'>handles</td><td style='font-family: monospace; padding: 8px 8px 0 8px'>third case</td></tr></table>")
N0 --> N2`);
    });
  });
